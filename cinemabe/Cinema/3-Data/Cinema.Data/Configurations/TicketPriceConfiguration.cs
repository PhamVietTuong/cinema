...
public class TicketPriceConfiguration : IEntityTypeConfiguration<TicketPrice>
{
    public void Configure(EntityTypeBuilder<TicketPrice> b)
    {
        ...
        // Restrict on the lookups so a referenced seat type / time slot can't be silently orphaned.
        ...
        b.HasIndex(p => new { p.TheaterId, p.SeatTypeId, p.TimeSlotId, p.IsHoliday }).IsUnique();
    }
}

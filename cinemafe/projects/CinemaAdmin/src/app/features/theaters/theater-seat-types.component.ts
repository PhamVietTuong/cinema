...
export class TheaterSeatTypesComponent extends CatalogCrudBase<Dto> {
  ...
  create(v: any) { return this._svc.createSeatType(CinemaServiceAgent.CreateSeatTypeRequest.fromJS({ ...v, theaterId: this.theaterId })); }
  update(v: any, id: string) { return this._svc.updateSeatType(CinemaServiceAgent.UpdateSeatTypeRequest.fromJS({ ...v, id, theaterId: this.theaterId })); }
